        ...
        <div class="center">
            <div class="con">
                <div class="header-con">
                    <h1>Pork Products</h1>
                    <p>> All Pork Products</p>
                    <div class="flex-prod">
                        <a href="./products.php"><div>Beef</div></a>
                        <a href="./porkprod.php"><div style="background: rgb(23, 68, 113);
                        color: white;">Pork</div></a>
                ...
                <div class="container">
                    <?php
                        ...
                        {
                            if($data['prod_type'] == 2 && ($data['prod_stocks'] >= 1)){
                    ?>
                    <div class="con-item" id="<?php echo $data['prod_id']; ?>">
                        <div class="img-con">
                            <img src="../assets/pork/<?php echo $data['prod_img']; ?>" alt="">
                        </div>
