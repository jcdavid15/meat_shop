        ...
        <div class="center">
            <div class="con">
                <div class="header-con">
                    ...
                    <p>> All Chicken Products</p>
                    <div class="flex-prod">
                        <a href="./products.php"><div>Beef</div></a>
                        <a href="./porkprod.php"><div>Pork</div></a>
                        <a href="./chickenprod.php"><div style="background: rgb(23, 68, 113);
                        color: white;">Chicken</div></a>
                ...
                <div class="container">
                    <?php
                        ...
                        {
                            if($data['prod_type'] == 3 && ($data['prod_stocks'] >= 1)){
                    ?>
                    <div class="con-item" id="<?php echo $data['prod_id']; ?>">
                        <div class="img-con">
                            <img src="../assets/chicken/<?php echo $data['prod_img']; ?>" alt="">
                        </div>
